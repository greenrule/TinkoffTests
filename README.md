# Проект по автоматизации тестирования Тинькофф
...
- [x] Проверка отображения главной страницы
- [x] Отсутствие ошибок в консоли на главной странице
- [x] Проверка перехода с главной страницы на вкладку Путешествие
